...
require (
	...
	k8c.io/kubermatic/v2 v2.21.0-beta.0.0.20220826114833-f1b1e4c39f94
	k8s.io/api v0.24.2
...
require (
	...
	k8c.io/operating-system-manager v1.0.0 // indirect
	...
	kubevirt.io/containerized-data-importer-api v1.52.0 // indirect
